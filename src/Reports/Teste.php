...
$sSQL = 'SELECT per_FirstName, per_LastName FROM person_per WHERE per_ID IN ('.ConvertCartToString($_SESSION['aPeopleCart']).') ORDER BY per_FirstName, per_MiddleName, per_LastName';
