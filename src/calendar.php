...
<div class="col">
  <div class="box box-primary">
    ...
    ?>
        <div class="col-xs-3 fc-event-container fc-day-grid-event" style="background-color:<?= $type['backgroundColor']?>;border-color:<?= $type['backgroundColor']?>;color: white; width:32%; text-align: center; padding: 10px;">
