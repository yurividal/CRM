			...
			<div class="row">
				<div class="form-group col-md-6">
					...
					<div class="input-group">
						...
						<input type="text" Name="HomePhone" value="<?= htmlentities(stripslashes($sHomePhone)) ?>" size="30" maxlength="30" class="form-control" data-inputmask='"mask": "<?= SystemConfig::getValue('sHomePhoneFormat')?>"' data-mask>
